...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navlist variant="outline">
                <flux:navlist.group :heading="__('Configuracion')" class="grid">
                    <flux:navlist.item icon="user" :href="route('subjects')" :current="request()->routeIs('subjects')" wire:navigate>{{ __('Sujetos') }}</flux:navlist.item>

                    <flux:navlist.item icon="list-bullet" :href="route('genres')" :current="request()->routeIs('genres')" wire:navigate>{{ __('Generos') }}</flux:navlist.item>

                    <flux:navlist.item icon="tag" :href="route('tags')" :current="request()->routeIs('tags')" wire:navigate>{{ __('Etiquetas') }}</flux:navlist.item>

                    <flux:navlist.item icon="numbered-list" :href="route('collections')" :current="request()->routeIs('collections')" wire:navigate>{{ __('Colecciones') }}</flux:navlist.item>
