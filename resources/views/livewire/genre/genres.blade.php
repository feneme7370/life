                            ...
                            <td class="px-3 py-2 whitespace-nowrap">
                                <div class="flex gap-1 justify-center items-center">
                                    <img class="w-16 h-16 object-cover rounded"
                                        src="{{ $genre->cover_image_url ?? 'https://static.vecteezy.com/system/resources/previews/004/141/669/non_2x/no-photo-or-blank-image-icon-loading-images-or-missing-image-mark-image-not-available-or-image-coming-soon-sign-simple-nature-silhouette-in-frame-isolated-illustration-vector.jpg'}}"
                                        alt="imagen">
                                </div>
                            </td>
                            <td class="px-3 py-2 whitespace-nowrap">{{ $genre->name }}</td>
                            <td class="px-3 py-2 whitespace-nowrap">
                                <div class="flex gap-1 justify-center items-center">
                                    <flux:button icon="pencil-square" size="sm" wire:click="edit('{{ $genre->uuid }}')">Editar</flux:button>
                                    <flux:button icon="trash" size="sm" variant="danger" wire:click="delete('{{ $genre->uuid }}')">Borrar</flux:button>
                                </div>
                            </td>
                        </tr>
                    @empty
